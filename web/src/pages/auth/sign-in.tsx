          ...
          <div className="relative z-20 mt-auto">
            <blockquote className="space-y-2">
              <p className="text-lg">
                ...
                lifestyle. Track your spending, set savings goals, and watch
                your financial dreams become a reality.
              </p>
            </blockquote>
          </div>
        </div>
          ...
          <div className="h-full mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
            <div className="flex flex-col space-y-2 text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Enter your email and password below to sign in with your account
              </p>
            </div>
